...
The 'LakeHousePerfume' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/LakeHousePerfume/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] LakeHousePerfume_etl` to your workspace.
